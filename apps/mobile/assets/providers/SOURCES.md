# Payment provider artwork

The app icons in this directory were downloaded on 2026-09-14 from the current Philippine App Store listings returned by Apple's public Search API:

- `gcash.jpg` — GCash, seller MYNT, INC., bundle `com.globetel.gcash`
- `maya.jpg` — Maya, seller Maya Philippines, Inc., bundle `com.paymaya.ios`
